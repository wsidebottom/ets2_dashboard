...
static const uint16_t bigNumbers[][10] PROGMEM = {
	...
	,{0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000} // &
	,{0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000} // '
	,{0x0000, 0x0000, 0x03F0, 0x03F0, 0x0C0C, 0x0C0C, 0x3003, 0x3003, 0x0000, 0x0000} // (
	,{0x0000, 0x0000, 0x3003, 0x3003, 0x0C0C, 0x0C0C, 0x03F0, 0x03F0, 0x0000, 0x0000} // )
	,{0x0330, 0x0330, 0x00C0, 0x00C0, 0x0FFC, 0x0FFC, 0x00C0, 0x00C0, 0x0330, 0x0330} // *
	,{0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x0FFC, 0x0FFC, 0x00C0, 0x00C0, 0x00C0, 0x00C0} // +
	,{0x0000, 0x0000, 0x3300, 0x3300, 0x0F00, 0x0F00, 0x0000, 0x0000, 0x0000, 0x0000} // ,
	,{0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0, 0x00C0} // -
	,{0x0000, 0x0000, 0x3C00, 0x3C00, 0x3C00, 0x3C00, 0x0000, 0x0000, 0x0000, 0x0000} // .
	,{0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000} // /
	,{0x0FFC, 0x0FFC, 0x3303, 0x3303, 0x30C3, 0x30C3, 0x3033, 0x3033, 0x0FFC, 0x0FFC} // 0
	...
	,{0x0C03, 0x0C03, 0x3003, 0x3003, 0x3033, 0x3033, 0x30CF, 0x30CF, 0x0F03, 0x0603} // 3
	,{0x0380, 0x03C0, 0x0330, 0x0330, 0x030C, 0x030C, 0x3FFF, 0x3FFF, 0x0300, 0x0300} // 4
	...
	,{0x0018, 0x003C, 0x30C3, 0x30C3, 0x30C3, 0x30C3, 0x0CC3, 0x0CC3, 0x03FC, 0x01F8} // 9
};
...
uint8_t displayMap[LCD_WIDTH * LCD_HEIGHT / 8] = {
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,0)->(35,7)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (36,0)->(47,7)
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,8)->(35,15)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (36,8)->(47,15)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (48,8)->(59,15)
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,16)->(35,23)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (36,16)->(47,23)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (48,16)->(59,23)
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,24)->(35,31)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (36,24)->(47,31)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (48,24)->(59,31)
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,32)->(35,39)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (36,32)->(47,39)
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (48,32)->(59,39)
	...
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // (24,40)->(35,47)
...
// sends the data byte
void PCD8544::write(uint8_t data_or_command, uint8_t data)
{
	//Tell the LCD that we are writing either to data or a command
	lcdDC(data_or_command);
...
void PCD8544::setPixel(int x, int y, bool bw)
{
...
void PCD8544::setPixel(int x, int y)
{
	setPixel(x, y, BLACK); // Call setPixel with bw set to Black
}

void PCD8544::clearPixel(int x, int y)
{
...
// library.
void PCD8544::setLine(int x0, int y0, int x1, int y1, bool bw)
{
...
// This function was grabbed from the SparkFun ColorLCDShield
// library.
void PCD8544::setRect(int x0, int y0, int x1, int y1, bool fill, bool bw)
{
...
// This function was grabbed from the SparkFun ColorLCDShield
// library.
void PCD8544::setCircle (int x0, int y0, int radius, bool bw, int lineThickness)
{
...
void PCD8544::setChar(char character, int x, int y, bool bw)
{
...
// This function was grabbed from the SparkFun ColorLCDShield
// library.
void PCD8544::setStr(char * dString, int x, int y, bool bw)
{
	while (*dString != 0x00) // loop until null terminator
	{
		setChar(*dString++, x, y, bw);
		x+=5;
		for (int i=y; i<y+8; i++) setPixel(x, i, !bw);
		x++;
...
int PCD8544::printf(int x, int y, bool bw, char *fmt, ...)
{
	char buf[60];
	va_list ap;
	int retval = 0;
...
void PCD8544::setCharBig(char character, int x, int y, bool bw)
{
	// Only Numbers & Space Supported

	uint16_t column; // temp byte to store character's column bitmap
	for (int i=0; i<10; i++) // 10 columns (x) per character
	{
		column = pgm_read_word(&bigNumbers[character-0x20][i]);
		for (int j=0; j<16; j++) // 16 rows (y) per character
		{
			// test bits to set pixels
			if (column & (0x01 << j)) setPixel(x+i, y+j, bw);
			else setPixel(x+i, y+j, !bw);
		}
	}
}

void PCD8544::setStrBig(char * dString, int x, int y, bool bw)
{
	while (*dString != 0x00) // loop until null terminator
	{
		setCharBig(*dString++, x, y, bw);
		x+=10;
		for (int i=y; i<y+16; i++) setPixel(x, i, !bw);
		x++;
...
int PCD8544::printfBig(int x, int y, bool bw, char *fmt, ...)
{
	char buf[60];
	va_list ap;
	int retval = 0;
...
void PCD8544::setBitmap(const char * bitArray)
{
...
void PCD8544::clearDisplay(bool bw)
{
	for (int i=0; i<(LCD_WIDTH * LCD_HEIGHT / 8); i++)
	{
...
void PCD8544::setContrast(uint8_t contrast)
{
	...
	write(LCD_COMMAND, 0x80 | contrast); //Set LCD Vop (Contrast): Try 0xB1(good @ 3.3V) or 0xBF if your display is too dark
...
void PCD8544::invertDisplay()
{
	...
	for (int i=0; i < (LCD_WIDTH * LCD_HEIGHT / 8); i++) displayMap[i] = ~displayMap[i] & 0xFF;
	updateDisplay();
}
...
void PCD8544::begin(void)
{
	...
	write(LCD_COMMAND, 0x21); //Tell LCD extended commands follow
	write(LCD_COMMAND, 0xB0); //Set LCD Vop (Contrast)
	write(LCD_COMMAND, 0x04); //Set Temp coefficent
	write(LCD_COMMAND, 0x14); //LCD bias mode 1:48 (try 0x13)
	//We must send 0x20 before modifying the display control mode
	write(LCD_COMMAND, 0x20);
	write(LCD_COMMAND, 0x0C); //Set display control, normal mode.
}
